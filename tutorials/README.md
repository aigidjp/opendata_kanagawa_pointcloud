...
The following sample shows the point cloud data of [Yokohama Stadium](https://www.yokohama-stadium.co.jp/).

<div align="center">
<img src="./images/CloudCompare_Yokohama_Stadium.png" alt="CloudCompare_Yokohama_Stadium" width="50%">
</div>

### QGIS

QGIS also allows you to display point cloud data by simply drag and drop las files. If a dialog for specifying the CRS appears, please select EPSG:6677.

<div align="center">
<img src="./images/QGIS_CRS_EPSG6677.png" alt="QGIS_Dialog_CRS" width="50%">
</div>

The following sample shows the point cloud data of [Nissan Stadium](https://www.nissan-stadium.jp/english/).

<div align="center">
<img src="./images/QGIS_Nissan_Stadium.png" alt="QGIS_Nissan_Stadium" width="50%">
</div>
